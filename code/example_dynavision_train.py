...
train(train_loader, test_loader, mode="width", method="naive", 
    ...
    embed_dim=192, depth=12, num_heads=3, mlp_ratio=4,  in_chans = 3, drop_rate=0, attn_drop_rate=0, drop_path_rate=0, distilled=False, act_layer=None, representation_size=None, width_list = [0.2, 0.4, 0.6, 0.8, 1], loss_fn=nn.CrossEntropyLoss(),
